...
export default function SignupPage() {
  ...
  const checkPasswordStrength = (password: string) => {
    ...
    const strength = 
      ...
      (hasUpperCase || hasLowerCase) && (hasNumbers || hasSpecialChars) ? 'medium' : 'weak';
      ...
      <div className="container mx-auto grid max-w-6xl grid-cols-1 gap-12 md:grid-cols-2 md:items-center">
        ...
        >
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            Create your <span className="font-semibold text-primary">Crowdfundify</span> account and bring your ideas to life.
          </motion.p>
        </motion.div>
