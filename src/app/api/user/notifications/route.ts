  ...
  try {
    ...
    await prismaClient.notificationSettings.update({
      ...
      data: {
        ...
        pushNotifications:
          pushNotifications !== 'undefined' ? pushNotifications : notifications.pushNotifications,
        newBackerNotification:
          newBackerNotification !== 'undefined'
            ? newBackerNotification
            : notifications.newBackerNotification,
        commentNotification:
          commentNotification !== 'undefined'
            ? commentNotification
        ...
        milestoneNotification:
          milestoneNotification !== 'undefined'
            ? milestoneNotification
